	...
	<div>
		...
		<form:form method="POST" modelAttribute="thing">
			...
			<fieldset>
				...
				<br /> <label for="phoneNumber">Cell phone:</label>
				<form:input path="phoneNumber" id="phoneNumber" size="30"
					maxlength="13" />
				<form:errors path="phoneNumber" cssClass="error" />
				<br /> <label for="lostOrFound">Lost or found:</label>
				<form:input path="lostOrFound" id="lostOrFound" size="30"
					maxlength="5" />
