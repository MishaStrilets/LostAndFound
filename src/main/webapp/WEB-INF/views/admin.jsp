...
<body>
	<div>
		<header>
			...
			<nav>
				<ul>
					<li><a href="<c:url value='/admin' />">Lost and found</a></li>
					<li><a href="<c:url value='/admin-lost' />">Lost</a></li>
					<li><a href="<c:url value='/admin-found' />">Found</a></li>
					<li><a href="<c:url value='/new' />">Add thing</a></li>
					<li><a href="<c:url value="/logout" />" class="log">Log out</a></li>
				</ul>
			</nav>
		</header>
		...
		<table align="center">
			...
			<c:forEach items="${things}" var="thing">
				<tr>
					...
					<td nowrap style="background-color: #f9f22a; border: 3px solid #8e8e0c;"><a href="<c:url value='/edit-${thing.id}-thing' />">Edit</a></td>
					<td nowrap style="background-color: #f92c41; border: 3px solid #590310;"><a href="<c:url value='/delete-${thing.id}-thing' />">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
